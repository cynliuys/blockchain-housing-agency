...
function (_React$Component) {
  ...
  function Table(props) {
    ...
    _this.getColumnTitle = function (title, parentNode) {
      if (!title) {
        return;
      }

      if (!(title instanceof Function) && typeof title !== 'string' && typeof title !== 'number') {
        var _props = title.props;

        if (_props && _props.children) {
          var children = _props.children;
          return _this.getColumnTitle(children, _props);
        }
      } else {
  ...
  _createClass(Table, [{
    ...
    value: function renderColumnsDropdown(prefixCls, dropdownPrefixCls, columns, locale) {
      ...
      return treeMap(columns, function (column, i) {
        ...
        var sortTitle = _this7.getColumnTitle(column.title, {}) || locale.sortTitle;

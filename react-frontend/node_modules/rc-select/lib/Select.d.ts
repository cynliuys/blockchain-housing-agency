...
declare class Select extends React.Component<Partial<ISelectProps>, ISelectState> {
    ...
    static getOptionsFromChildren: (children: React.ReactElement<any>[], options?: any[]) => any[];
    ...
    setOpenState: (open: boolean, needFocus?: boolean | undefined) => void;
    ...
    renderFilterOptions: () => JSX.Element[];
    renderFilterOptionsFromChildren: (children: React.ReactElement<any>[], childrenKeys: string[], menuItems: JSX.Element[]) => JSX.Element[];
